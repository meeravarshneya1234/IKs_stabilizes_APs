function deriv = dydt_LivshitzAPclamp(t,statevar,V,p,c)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%--------------------------------------------------------------------------
                            %% -- dydt_LivshitzAPclamp.m --%%
% Description: Runs the "AP Clamp Simulation for the Livshitz Model based
% on the following article --:
        % Livshitz L and Rudy Y. Uniqueness and stability of action
        % potential models during rest, pacing, and conduction using
        % problem-solving environment. Biophys J. 2009;97:1265-76.
...
Id = 0;
[Cai,CaNSR,CaJSR,Nai,Ki,m,h,j,d,f,b,g,xKr,xs1,xs2,Jrel] = ...
  deal(statevarcell{:}) ;
...
deriv = [dCai;dCaNSR;dCaJSR;dNai;dKi; ...
