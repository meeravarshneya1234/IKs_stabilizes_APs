function deriv = dydt_TT06APclamp(t,statevar,V,p,c)
...
%--------------------------------------------------------------------------
                            %% -- dydt_TT06APclamp.m --%%
% Description: Runs the "AP Clamp Simulation for the TT06 Model based on
...
% --> V - [array] voltage input to perform AP clamp
...
Id =0;
[m,h,j,d,f,f2,fCass,r,s,xs,xr1,xr2,Rbar_ryr,Cai,Cass,CaSR,Nai,Ki] = ...
  deal(statevarcell{:}) ;
% %%%%%%%%%%%%%%%%%%%%%%%%%
% %% 
...
deriv = [dmdt;dhdt;djdt;dddt;dfdt;df2dt;dfCassdt;drdt;dsdt; ...
